...
import Module14task5_crud_functions
...
async def set_username(message, state):
    if Module14task5_crud_functions.is_included(message.text)==True:
...
async def set_age(message, state):
    ...
    Module14task5_crud_functions.add_user(new_user['username'],new_user['email'],new_user['age'])
    await state.clear()
